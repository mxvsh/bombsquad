...
values = {
    'accountSettingsWindow':{
        ...
        'changeOncePerSeason':'فقط میتوانید یک بار هر فصل تغییر دهید',
        'changeOncePerSeasonError':'(روز تا فصل بعد ${NUM}) برای تغییر این گذینه باید تا فصل بعد صبر کنید',
        'customName':'نام',
        ...
        'linkAccountsInstructionsNewText':('برای اتصال دو حساب کاربری، ابتدا یک کد در حساب اول بسازید\n'
                                           ...
                                           'اگر شما به حساب دوستتان متصل شوید،\n'
                                           ' نمی توانید در آن واحد آنلاین بازی کنید.'),
        ...
        'nameChangeConfirm':'مطمعنید؟ ${NAME} آیا از تغییر نامتان به',
