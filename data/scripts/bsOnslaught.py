...
class OnslaughtGame(bs.CoopGameActivity):
    ...
    tips = ['Hold any button to run.  (Trigger buttons work well if you have them)',
    ...
    def onTransitionIn(self):
        ...
        if self._preset in ['rookie','rookieEasy']:
            ...
            if not hasattr(bs.getSession(),'_gShowedOnslaughtLandMineTip'):
                ...
                self.tips = [{'tip':"Land-mines are a good way to stop speedy enemies.",
        ...
        if self._preset in ['pro','proEasy']:
            ...
            if not hasattr(bs.getSession(),'_gShowedOnslaughtTntTip'):
                ...
                self.tips = [{'tip':"Take out a group of enemies by\nsetting off a bomb near a TNT box.",
        ...
        if self._preset in ['uber','uberEasy']:
            ...
            if not hasattr(bs.getSession(),'_gShowedOnslaughtCurseTip'):
                ...
                self.tips = [{'tip':"Curse boxes turn you into a ticking time bomb.\nThe only cure is to quickly grab a health-pack.",
    ...
    def onBegin(self):
        ...
        hard = False if self._preset in ['trainingEasy','rookieEasy','proEasy','uberEasy'] else True
        ...
        if self._preset  in ['training','trainingEasy']:
            ...
            self._waves = [
                ...
                {'baseAngle':130,
                 'entries':([
                            {'type':bs.ToughGuyBotLame,'spacing':5} if playerCount > 1 else None,
                            {'type':bs.ToughGuyBotLame,'spacing':5},
                            {'type':None,'spacing':30},
                            {'type':bs.BomberBotLame,'spacing':5} if playerCount > 3 else None,
                            {'type':bs.BomberBotLame,'spacing':5},
                            {'type':None,'spacing':30},
                            {'type':bs.ToughGuyBotLame,'spacing':5},
                            {'type':bs.ToughGuyBotLame,'spacing':5} if playerCount > 2 else None,
                            ])},

                {'baseAngle':195,
                 'entries':([
                            {'type':bs.ChickBot,'spacing':90},
                            {'type':bs.ChickBot,'spacing':90} if playerCount > 1 else None
                            ])},
                ]
            ...
            self._waves = [
                ...
                {'entries':[
                        {'type':bs.NinjaBot,'point':'LeftUpperMore'} if playerCount > 2 else None,
                ...
                {'entries':[
                        ...
                        {'type':bs.ToughGuyBotLame,'point':'RightLower'} if playerCount > 1 else None,
                        {'type':bs.BomberBotStaticLame,'point':'TurretBottomRight'} if playerCount > 2 else None,
                        ]},

                {'entries':[
                        {'type':bs.BomberBotStaticLame,'point':'TurretBottomLeft'},
                        {'type':bs.ChickBot,'point':'Left'},
                        {'type':bs.ChickBot,'point':'LeftLower'} if playerCount > 1 else None,
                        {'type':bs.ChickBot,'point':'LeftUpper'} if playerCount > 2 else None,
                        ]},
                {'entries':[
                        {'type':bs.ToughGuyBotLame,'point':'TopRight'},
                        {'type':bs.ToughGuyBot,'point':'TopHalfRight'} if playerCount > 1 else None,
                        {'type':bs.ToughGuyBotLame,'point':'TopLeft'},
                        {'type':bs.ToughGuyBotLame,'point':'TopHalfLeft'} if playerCount > 2 else None,
                        {'type':bs.ToughGuyBot,'point':'Top'},
                        {'type':bs.BomberBotStaticLame,'point':'TurretTopMiddle'},
                        ]},
                ...
                {'entries':[
                        ...
                        {'type':bs.ChickBot,'point':'BottomHalfRight'} if playerCount > 1 else None,
                        {'type':bs.ChickBot,'point':'BottomHalfLeft'} if playerCount > 2 else None,
                        ]},
                ...
                {'entries':[
                        ...
                        {'type':bs.NinjaBot,'point':'BottomHalfLeft'} if playerCount > 1 else None,
                        {'type':bs.NinjaBot,'point':'BottomHalfRight'} if playerCount > 2 else None,
                        ]},
                ]
            ...
            self._waves = [
                ...
                {'baseAngle':-50,
                 'entries':([
                            {'type':bs.ToughGuyBot,'spacing':12} if playerCount > 3 else None,
                            {'type':bs.ToughGuyBot,'spacing':12},
                            {'type':bs.BomberBot,'spacing':6},
                            {'type':bs.BomberBot,'spacing':6} if self._preset == 'pro' else None,
                            {'type':bs.BomberBot,'spacing':6} if playerCount > 1 else None,
                            {'type':bs.ToughGuyBot,'spacing':12},
                ...
                {'baseAngle':180,
                 'entries':([
                            ...
                            {'type':bs.NinjaBot,'spacing':45} if playerCount > 1 else None,
                            {'type':bs.ToughGuyBot,'spacing':6},
                            {'type':bs.ToughGuyBot,'spacing':6} if self._preset == 'pro' else None,
                ...
                #             {'type':bs.ToughGuyBot,'spacing':10},
                #             {'type':bs.ToughGuyBot,'spacing':10},
                #             {'type':bs.ToughGuyBot,'spacing':10} if playerCount > 1 else None,
                #             {'type':bs.ToughGuyBot,'spacing':10} if playerCount > 3 else None,
                #             {'type':bs.NinjaBot,'spacing':20},
                #             {'type':None,'spacing':70},
                ...
                {'baseAngle':0,
                 'entries':([
                            ...
                            {'type':bs.ChickBot,'spacing':30},
                            {'type':bs.ChickBot,'spacing':30} if self._preset == 'pro' else None,
                            {'type':bs.ChickBot,'spacing':30} if playerCount > 1 else None,
                ...
                {'baseAngle':90,
                 'entries':([
                            ...
                            {'type':bs.MelBot,'spacing':50} if self._preset == 'pro' else None,
                            {'type':bs.MelBot,'spacing':50},
                ...
                {'baseAngle':0,
                 'entries':([
                            ...
                            {'type':bs.ChickBot,'spacing':72},
                            {'type':bs.ChickBot,'spacing':72} if self._preset == 'pro' else None,
                            {'type':bs.ChickBot,'spacing':72},
                            {'type':bs.ChickBot,'spacing':72},
            ...
            self._waves = [
                ...
                {'entries':[
                        {'type':bs.BomberBotProStatic,'point':'TurretTopMiddleLeft'} if hard else None,
                        {'type':bs.BomberBotProStatic,'point':'TurretTopMiddleRight'},
                        {'type':bs.BomberBotProStatic,'point':'TurretTopLeft'} if playerCount > 2 else None,
                ...
                {'entries':[
                        ...
                        {'type':bs.NinjaBot,'point':'RightUpperMore'} if playerCount > 2 else None,
                ...
                {'entries':[
                        ...
                        {'type':bs.ChickBotPro,'point':'RightUpperMore'} if playerCount > 1 else None,
                        {'type':bs.ChickBotPro,'point':'RightUpper'}, 
                        {'type':bs.ChickBotPro,'point':'RightLower'} if hard else None,
                        {'type':bs.ChickBotPro,'point':'RightLowerMore'} if playerCount > 2 else None,
                ...
                {'entries':[
                        ...
                        {'type':bs.NinjaBotProShielded,'point':'Top'} if hard else None,
                ...
                {'entries':[
                        ...
                        {'type':bs.ToughGuyBotProShielded,'point':'LeftLowerMore'},
                        {'type':'delay','duration':4000},
                        {'type':bs.PirateBot,'point':'RightUpper'},
                        {'type':'delay','duration':1000},
                        {'type':bs.ToughGuyBotProShielded,'point':'RightLower'},
                        {'type':bs.ToughGuyBotProShielded,'point':'RightUpperMore'},
                        {'type':'delay','duration':4000},
                ...
                {'entries':[
                        ...
                        {'type':bs.BomberBotProStatic,'point':'TurretTopMiddleLeft'} if hard else None,
                        {'type':bs.BomberBotProStatic,'point':'TurretTopMiddleRight'} if hard else None,
                        ]},
                ]
        ...
        else: raise Exception("Invalid preset: "+str(self._preset))

        # FIXME - should migrate to use setupStandardPowerupDrops()
        
        # spit out a few powerups and start dropping more shortly
        self._dropPowerups(standardPoints=True,powerupType='curse' if self._preset in ['uber','uberEasy'] else ('landMines' if self._preset in ['rookie','rookieEasy'] else None))
    ...
    def spawnPlayer(self,player):
        ...
        if self._preset in ['trainingEasy','rookieEasy','proEasy','uberEasy']:
            s._impactScale = 0.25
    ...
    def _updateWaves(self):
        ...
        if self._canEndWave and not self._bots.haveLivingBots() and not self._gameOver:
            ...
            if won:
                ...
                if self._preset in ['training','trainingEasy']:
                    self._awardAchievement('Onslaught Training Victory',sound=False)
                    if not self._playerHasDroppedBomb:
                        self._awardAchievement('Boxer',sound=False)
                elif self._preset in ['rookie','rookieEasy']:
                    self._awardAchievement('Rookie Onslaught Victory',sound=False)
                    ...
                    self._awardAchievement('Uber Onslaught Victory',sound=False)
    ...
    def _updatePlayerSpawnInfo(self):
        ...
        if not any(player.isAlive() for player in self.teams[0].players):
            ...
            t = ''
            for player in self.players:
                if not player.isAlive() and (self._preset in ['endless','endlessTournament'] or (player.gameData['respawnWave'] <= len(self._waves))):
    ...
    def _startNextWave(self):
        ...
        if self._preset in ['endless','endlessTournament']:
            ...
            if not all([len(a) > 0 for a in botLevels]): raise Exception()

            targetPoints = level*3-2
            minDudes = min(1+level/3,10)
            maxDudes = min(10,level+1)
            maxLevel = 4 if level > 6 else (3 if level > 3 else (2 if level > 2 else 1))
            groupCount = 3
            distribution = self._getDistribution(targetPoints,minDudes,maxDudes,groupCount,maxLevel)
            ...
            for group in distribution:
                ...
                for entry in group:
                    ...
                    r = random.random()
                    if r < 0.5: spacing = 10
                    elif r < 0.9: spacing = 20
                    else: spacing = 40
                    split = random.random() > 0.3
                    for i in range(entry[1]):
                        if split and i%2==0: entries.insert(0,{"type":botType, "spacing":spacing})
                        else: entries.append({"type":botType, "spacing":spacing})
                if len(entries) > 0:
                    allEntries += entries
                    allEntries.append({"type":None,"spacing":40 if random.random() < 0.5 else 80})

            angleRand = random.random()
            if angleRand > 0.75: baseAngle = 130
            elif angleRand > 0.5: baseAngle = 210
            elif angleRand > 0.25: baseAngle = 20
            else: baseAngle = -30
    ...
    def _updateScores(self):
        ...
        if self._preset == 'endless':
            if score >= 500: self._awardAchievement('Onslaught Master')
            if score >= 1000: self._awardAchievement('Onslaught Wizard')
            if score >= 5000: self._awardAchievement('Onslaught God')
            ...
            if m.killerPlayer is not None:
                ...
                if self._preset in ['training','trainingEasy']:
                    if m.badGuy.lastAttackedType == ('pickedUp','default'):
                        if not hasattr(self,'_throwOffKills'): self._throwOffKills = 0
                ...
                # land-mine achievement
                    ...
                    if m.badGuy.lastAttackedType == ('explosion','landMine'):
                        if not hasattr(self,'_landMineKills'): self._landMineKills = 0
                ...
                # tnt achievement
                    ...
                    if m.badGuy.lastAttackedType == ('explosion','tnt'):
                        if not hasattr(self,'_tntKills'): self._tntKills = 0
                        self._tntKills += 1
                        if self._tntKills >= 3: 
                            bs.gameTimer(500,bs.WeakCall(self._awardAchievement,'Boom Goes the Dynamite'))
                    ...
                    if m.badGuy.lastAttackedType == ('explosion','tnt'):
                        ...
                        self._tntKills += 1
                        if self._tntKills >= 6: 
                            bs.gameTimer(500,bs.WeakCall(self._awardAchievement,'TNT Terror'))
